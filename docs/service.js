(function() {
  ...
  $urls = ['/abecedarian/favicon.png', '/abecedarian/icon-192.png', '/abecedarian/icon-512.png', '/abecedarian/touch-icon-ipad.png', '/abecedarian/touch-icon-ipad-retina.png', '/abecedarian/touch-icon-iphone-retina.png', '/abecedarian/index.css', '/abecedarian/index.js', '/abecedarian/index.html', '/abecedarian/'];
